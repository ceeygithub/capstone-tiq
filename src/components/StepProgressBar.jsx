    ...
    <div className='progress-wrapper'>
      <ProgressBar percent={(currentStep - 1) * 50} filledBackground="#FF7845">
        ...
        <Step transition="scale">
          {({ accomplished }) => (
            <div className="step-wrapper">
              <div className="step-circle" style={{ backgroundColor: accomplished ? '#083A55' : '#4A4A4A' }}>1</div>
              <p className="step-label">Personality Test</p>
            </div>
          )}
        </Step>
        {/* Step 2 */}
        <Step transition="scale">
          {({ accomplished }) => (
            <div className="step-wrapper">
              <div className="step-circle" style={{ backgroundColor: accomplished ? '#083A55' : '#4A4A4A' }}>2</div>
              <p className="step-label">Intelligence Test</p>
            </div>
          )}
        </Step>
        {/* Step 3 */}
        <Step transition="scale">
          {({ accomplished }) => (
            <div className="step-wrapper">
              <div className="step-circle" style={{ backgroundColor: accomplished ? '#083A55' : '#4A4A4A' }}>3</div>
              <p className="step-label">Qualitative Inquiry</p>
            </div>
          )}
        </Step>
      </ProgressBar>
