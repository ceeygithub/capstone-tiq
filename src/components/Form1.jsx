...
// const Form1 = ({ formData,  nextForm ,handleChange, }) => {
//  const [seconds, setSeconds] = useState(0);
...
//            <div  className='timer'><TfiTimer className='timerIcon'/> {formatTime(timerDuration - seconds)}</div>
//              <fieldset>
//             <label htmlFor='entry.598938948' className='question'>On a scale of 1 to 5, how much do you agree with the statement: "I enjoy meeting new people and socializing at events?  </label>

//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Strongly disagree"><input id="entry.598938948" type="radio" name="entry.598938948" value="Strongly disagree" onChange={handleChange} /> Strongly disagree</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Disagree"><input id="entry.598938948" type="radio" name="entry.598938948" value="Disagree"  onChange={handleChange}/> Disagree</label>
//           </div>
           
//       <div  className='answer'>
//            <label htmlFor="Neutral"><input id="entry.598938948" type="radio" name="entry.598938948" value="Neutral" onChange={handleChange}/> Neutral</label>
//       </div>
//    <div  className='answer'>
//   <label htmlFor="Agree"><input id="entry.598938948" type="radio" name="entry.598938948" value="Agree" onChange={handleChange} /> Agree</label>
//    </div>
//             <div className='answer'>
//     <label htmlFor="Strongly agree"><input id="entry.598938948" type="radio" name="entry.598938948" value="Strongly agree" onChange={handleChange}/> Strongly agree</label>
//             </div>
...
//          <fieldset>
//             <label htmlFor='entry.437721044' className='question'>Do you prefer working alone or in a team?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Alone"><input id="entry.437721044" type="radio" name="entry.437721044" value="Alone"  onChange={handleChange}/> Alone</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="In a team"><input id="entry.437721044" type="radio" name="entry.437721044" value="In a team"  onChange={handleChange}/> In a team</label>
//           </div>
...
//           </fieldset>
//            <fieldset>
//             <label htmlFor='entry.653007320' className='question'>How organized do you consider yourself to be in your daily life?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Very disorganized"><input id="entry.653007320" type="radio" name="entry.653007320" value="Very disorganized" onChange={handleChange} /> Very disorganized</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Somewhat disorganized"><input id="entry.653007320" type="radio" name="entry.653007320" value="Somewhat disorganized" onChange={handleChange}/> Somewhat disorganized</label>
//           </div>
           
//       <div  className='answer'>
//            <label htmlFor="Neither organized nor disorganized"><input id="entry.653007320" type="radio" name="entry.653007320" value="Neither organized nor disorganized" onChange={handleChange}/> Neither organized nor disorganized</label>
//       </div>
//    <div  className='answer'>
//   <label htmlFor="Somewhat organized"><input id="entry.653007320" type="radio" name="entry.653007320" value="Somewhat organized" onChange={handleChange}/> Somewhat organized</label>
//    </div>
//             <div className='answer'>
//     <label htmlFor="Very organized"><input id="entry.653007320" type="radio" name="entry.653007320" value="Very organized" onChange={handleChange}/> Very organized</label>
//             </div>
          
//          </div>
      
//           </fieldset> <fieldset>
//             <label htmlFor='entry.1328785535' className='question'>When faced with a problem, do you prefer to tackle it head-on or take time to analyze the situation first?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Tackle it head-on"><input id="entry.1328785535" type="radio" name="entry.1328785535" value="Tackle it head-on" onChange={handleChange}/> Tackle it head-on</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Take time to analyze the situation first"><input id="entry.1328785535" type="radio" name="entry.1328785535" value="Take time to analyze the situation first" onChange={handleChange}/> Take time to analyze the situation first</label>
//           </div>
           
//          </div>
      
//           </fieldset> <fieldset>
//             <label htmlFor='entry.325509377' className='question'>Are you more likely to trust your intuition or rely on factual evidence when making decisions?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Trust intuition"><input id="entry.325509377" type="radio" name="entry.325509377" value="Trust intuition" onChange={handleChange}/> Trust intuition</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Rely on factual evidence."><input id="entry.325509377" type="radio" name="entry.325509377" value="Rely on factual evidence." onChange={handleChange}/> Rely on factual evidence.</label>
//           </div>
          
//          </div>
      
//           </fieldset> <fieldset>
//             <label htmlFor='entry.1921020729' className='question'>When faced with a complex technical problem, do you prefer to:</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Dive right in and experiment with different solutions."><input id="entry.1921020729" type="radio" name="entry.1921020729" value="Dive right in and experiment with different solutions." onChange={handleChange} /> Dive right in and experiment with different solutions.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Take a step back and analyze the problem thoroughly before taking action."><input id="entry.1921020729" type="radio" name="entry.1921020729" value="Take a step back and analyze the problem thoroughly before taking action." onChange={handleChange} /> Take a step back and analyze the problem thoroughly before taking action.</label>
//           </div>
...
//           </fieldset> <fieldset>
//             <label htmlFor='entry.2079864328' className='question'>In a team project, do you typically take on the role of:</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="The leader who delegates tasks and ensures the project stays on track."><input id="entry.2079864328" type="radio" name="entry.2079864328" value="The leader who delegates tasks and ensures the project stays on track." onChange={handleChange}/> The leader who delegates tasks and ensures the project stays on track.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="The collaborator who contributes ideas and supports team members in their tasks."><input id="entry.2079864328" type="radio" name="entry.2079864328" value="The collaborator who contributes ideas and supports team members in their tasks."  onChange={handleChange}/> The collaborator who contributes ideas and supports team members in their tasks.</label>
//           </div>
...
//           </fieldset> <fieldset>
//             <label htmlFor='entry.114346058' className='question'>How do you approach learning new technical skills?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Through hands-on experimentation and trial-and-error"><input id="entry.114346058" type="radio" name="entry.114346058" value="Through hands-on experimentation and trial-and-error" onChange={handleChange}/> Through hands-on experimentation and trial-and-error</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Through structured courses and step-by-step tutorials."><input id="entry.114346058" type="radio" name="entry.114346058" value="Through structured courses and step-by-step tutorials." onChange={handleChange}/> Through structured courses and step-by-step tutorials.</label>
//           </div>
          
//          </div>
      
//           </fieldset> <fieldset>
//             <label htmlFor='entry.387785006' className='question'>When working on a challenging coding task, how do you handle setbacks or bugs?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Persistently troubleshoot until finding a solution."><input id="entry.387785006" type="radio" name="entry.387785006" value="Persistently troubleshoot until finding a solution." onChange={handleChange}/> Persistently troubleshoot until finding a solution.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Seek assistance or collaborate with others to overcome the obstacle."><input id="entry.387785006" type="radio" name="entry.387785006" value="Seek assistance or collaborate with others to overcome the obstacle." onChange={handleChange} /> Seek assistance or collaborate with others to overcome the obstacle.</label>
//           </div>
          
//          </div>
      
//           </fieldset> <fieldset>
//             <label htmlFor='entry.1979975041' className='question'>When working on a team project, how do you handle disagreements or conflicts?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Address the issue directly and work towards finding a resolution."><input id="entry.1979975041" type="radio" name="entry.1979975041" value="Address the issue directly and work towards finding a resolution." onChange={handleChange} /> Address the issue directly and work towards finding a resolution.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Step back and allow others to resolve the conflict while focusing on your tasks."><input id="entry.1979975041" type="radio" name="entry.1979975041" value="Step back and allow others to resolve the conflict while focusing on your tasks." onChange={handleChange} /> Step back and allow others to resolve the conflict while focusing on your tasks.</label>
//           </div>
...
//           </fieldset> <fieldset>
//             <label htmlFor='entry.1100611344' className='question'>How do you prioritize tasks when working on multiple projects simultaneously?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="By assessing deadlines and importance to determine the order of tasks."><input id="entry.1100611344" type="radio" name="entry.1100611344" value="By assessing deadlines and importance to determine the order of tasks." onChange={handleChange}/> By assessing deadlines and importance to determine the order of tasks.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="By focusing on tasks that align with your interests and strengths first."><input id="entry.1100611344" type="radio" name="entry.1100611344" value="By focusing on tasks that align with your interests and strengths first." onChange={handleChange}/> By focusing on tasks that align with your interests and strengths first.</label>
//           </div>
          
//          </div>
      
//           </fieldset> <fieldset>
//             <label htmlFor='entry.953172023' className='question'>When working on a team project, what role do you naturally gravitate towards?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="The problem solver who identifies and addresses technical challenges."><input id="entry.953172023" type="radio" name="entry.953172023" value="The problem solver who identifies and addresses technical challenges." onChange={handleChange}/> The problem solver who identifies and addresses technical challenges.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="The collaborator who facilitates communication and coordination among team members."><input id="entry.953172023" type="radio" name="entry.953172023" value="The collaborator who facilitates communication and coordination among team members." onChange={handleChange}/> The collaborator who facilitates communication and coordination among team members.</label>
//           </div>
...
//           </fieldset> <fieldset>
//             <label htmlFor='entry.1260446104' className='question'>How do you typically recharge after a long day or week of work?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="By spending time alone, engaging in quiet activities like reading or listening to music."><input id="entry.1260446104" type="radio" name="entry.1260446104" value="By spending time alone, engaging in quiet activities like reading or listening to music." onChange={handleChange}/> By spending time alone, engaging in quiet activities like reading or listening to music.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="By socializing with friends or participating in group activities to unwind."><input id="entry.1260446104" type="radio" name="entry.1260446104" value="By socializing with friends or participating in group activities to unwind." onChange={handleChange}/> By socializing with friends or participating in group activities to unwind.</label>
//           </div>
...
//           </fieldset> <fieldset>
//             <label htmlFor='entry.495106899' className='question'>When working on a team project, do you prefer to:</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Take on individual tasks and work independently to achieve the project goals."><input id="entry.495106899" type="radio" name="entry.495106899" value="Take on individual tasks and work independently to achieve the project goals." onChange={handleChange}/> Take on individual tasks and work independently to achieve the project goals.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Collaborate closely with team members, discussing ideas and sharing responsibilities"><input id="entry.495106899" type="radio" name="entry.495106899" value="Collaborate closely with team members, discussing ideas and sharing responsibilities" onChange={handleChange}/> Collaborate closely with team members, discussing ideas and sharing responsibilities</label>
//           </div>
          
//          </div>
      
//           </fieldset> <fieldset>
//             <label htmlFor='entry.1382775517' className='question'>How do you feel about public speaking or presenting in front of a group?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Uncomfortable or nervous, preferring to avoid public speaking whenever possible."><input id="entry.1382775517" type="radio" name="entry.1382775517" value="Uncomfortable or nervous, preferring to avoid public speaking whenever possible." onChange={handleChange}/> Uncomfortable or nervous, preferring to avoid public speaking whenever possible.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Comfortable and confident, enjoying the opportunity to share ideas and engage with an audience."><input id="entry.1382775517" type="radio" name="entry.1382775517" value="Comfortable and confident, enjoying the opportunity to share ideas and engage with an audience." onChange={handleChange}/> Comfortable and confident, enjoying the opportunity to share ideas and engage with an audience.</label>
//           </div>
          
//          </div>
      
//           </fieldset> <fieldset>
//             <label htmlFor='entry.1924166614' className='question'>In social settings, do you tend to</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Listen more than you speak, preferring to observe and process information before contributing"><input id="entry.1924166614" type="radio" name="entry.1924166614" value="Listen more than you speak, preferring to observe and process information before contributing" onChange={handleChange}/> Listen more than you speak, preferring to observe and process information before contributing</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Initiate conversations and actively engage with others, enjoying the energy of social interactions."><input id="entry.1924166614" type="radio" name="entry.1924166614" value="Initiate conversations and actively engage with others, enjoying the energy of social interactions." onChange={handleChange} /> Initiate conversations and actively engage with others, enjoying the energy of social interactions.</label>
//           </div>
...
//           </fieldset> <fieldset>
//             <label htmlFor='entry.1027322545' className='question'>When faced with a leadership opportunity, how do you approach the role?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="With caution, preferring to support others in leadership roles rather than take on the responsibility yourself."><input id="entry.1027322545" type="radio" name="entry.1027322545" value="With caution, preferring to support others in leadership roles rather than take on the responsibility yourself." onChange={handleChange}/> With caution, preferring to support others in leadership roles rather than take on the responsibility yourself.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="With enthusiasm, embracing the challenge and actively seeking opportunities to lead and make decisions"><input id="entry.1027322545" type="radio" name="entry.1027322545" value="With enthusiasm, embracing the challenge and actively seeking opportunities to lead and make decisions" onChange={handleChange}/> With enthusiasm, embracing the challenge and actively seeking opportunities to lead and make decisions</label>
//           </div>
        
//          </div>
      
//           </fieldset> <fieldset>
//             <label htmlFor='entry.212590982' className='question'>How do you prefer to communicate with team members or colleagues?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Through written communication channels like email or messaging apps, allowing for thoughtful consideration of responses."><input id="entry.212590982" type="radio" name="entry.212590982" value="Through written communication channels like email or messaging apps, allowing for thoughtful consideration of responses." onChange={handleChange}/> Through written communication channels like email or messaging apps, allowing for thoughtful consideration of responses.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Through verbal communication channels like phone calls or face-to-face meetings, facilitating real-time interaction and collaboration."><input id="entry.212590982" type="radio" name="entry.212590982" value="Through verbal communication channels like phone calls or face-to-face meetings, facilitating real-time interaction and collaboration." onChange={handleChange}/> Through verbal communication channels like phone calls or face-to-face meetings, facilitating real-time interaction and collaboration.</label>
//           </div>
    
//          </div>
      
//           </fieldset> <fieldset>
//             <label htmlFor='entry.483777567' className='question'>How do you approach networking or building professional relationships?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="Selectively, preferring to build deeper connections with a few individuals rather than engaging in large networking events."><input id="entry.483777567" type="radio" name="entry.483777567" value="Selectively, preferring to build deeper connections with a few individuals rather than engaging in large networking events." onChange={handleChange}/> Selectively, preferring to build deeper connections with a few individuals rather than engaging in large networking events.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="Proactively, enjoying the opportunity to meet new people and expand your professional network through various events and activities."><input id="entry.483777567" type="radio" name="entry.483777567" value="Proactively, enjoying the opportunity to meet new people and expand your professional network through various events and activities." onChange={handleChange}/> Proactively, enjoying the opportunity to meet new people and expand your professional network through various events and activities.</label>
//           </div>
        
//          </div>
      
//           </fieldset> <fieldset>
//             <label htmlFor='entry.795420714' className='question'>How do you feel about solving complex problems using logical reasoning and algorithms?</label>
            
//          <div className='answerContainer'>
//   <div className='answer'>
//  <label htmlFor="I enjoy the challenge and find satisfaction in solving problems logically."><input id="entry.795420714" type="radio" name="entry.795420714" value="I enjoy the challenge and find satisfaction in solving problems logically." onChange={handleChange} /> I enjoy the challenge and find satisfaction in solving problems logically.</label>
//         </div>
//           <div className='answer'>
//    <label htmlFor="I prefer tasks that involve creativity and innovation rather than strict logic."><input id="entry.795420714" type="radio" name="entry.795420714" value="I prefer tasks that involve creativity and innovation rather than strict logic." onChange={handleChange}/> I prefer tasks that involve creativity and innovation rather than strict logic.</label>
//           </div>
